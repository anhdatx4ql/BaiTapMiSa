...
namespace WebApplication.Controllers
{
    ...
    [ApiController]
    public class CustomerPotentialTypeController : ControllerBase
    {
        private readonly ICustomerPotentialTypeService _customerFiled;
        public CustomerPotentialTypeController(ICustomerPotentialTypeService customerFiled)
        {
